...
namespace tekno.Services.APIs
{
    ...
    public class Request
    {
        ...
        internal JObject m_jsonObj = null;
        ...
        {
            get { return this.m_jsonObj; }
            set { this.m_jsonObj= value; }
        }
        ...
        public T ExecuteRequest<T>()
        {
            ...
            try
            {
                Monitor.TryEnter(Services.GlobalLock, 500);
        ...
        public void BeginRequest()
        {
            ...
            {
                Monitor.TryEnter(Services.GlobalLock, 500);
                //Monitor.Enter(Services.GlobalLock, ref acquiredLock);
                //TimeSpan timeSinceLastRequest = DateTime.Now.Subtract(Services.LastRequest);
        ...
        internal virtual void CreateRequest()
        {
            ...
            else if (Method == requestMethod.POST)
            {
                ...
                else
                {
                    ...
                    Stream PostData = WebReq.GetRequestStream();
                    byte[] jsonBufferData = Encoding.UTF8.GetBytes(jsonObj.ToString());
                    PostData.Write(jsonBufferData, 0, jsonBufferData.Length);
                    PostData.Close();
                }
